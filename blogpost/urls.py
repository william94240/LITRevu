...
urlpatterns = [
    ...
    path("tickets/<slug:ticket_slug>/reviews/<slug:slug>/update/", ReviewUpdateView.as_view(),
         name="ticket-review-update"),
    path("tickets/<slug:ticket_slug>/reviews/<slug:slug>/delete/", ReviewDeleteView.as_view(),
         name="ticket-review-delete"),
